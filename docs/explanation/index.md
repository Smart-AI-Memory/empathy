...
- :material-account-group: **[Multi-Agent Philosophy](multi-agent-philosophy.md)**

    Why we use collaborative agent teams

- :material-school: **[How Claude Learns](HOW_CLAUDE_LEARNS.md)**

    Understanding Claude's learning approach
...
- :material-book-open: **[Teaching AI Your Philosophy](TEACHING_AI_YOUR_PHILOSOPHY.md)**

    How to customize AI behavior with your values

- :material-brain: **[Adaptive Learning](adaptive-learning.md)**

    How the framework learns from interactions

- :material-compare: **[Comparison](COMPARISON.md)**

    How Empathy compares to other AI frameworks
