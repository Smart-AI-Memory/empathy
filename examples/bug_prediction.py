...
class BugPredictor:
    ...
    def predict_bugs(
        ...
        bug_risks = self._identify_bug_risks(current_code_metrics, trajectory_analysis)
    ...
    def _analyze_trajectory(
        ...
        complexity_trend = self._calculate_metric_trend(historical, "avg_complexity")

        test_coverage_trend = self._calculate_metric_trend(historical, "test_coverage")

        bug_rate_trend = self._calculate_metric_trend(historical, "bugs_per_week")
